        ...
        <div className="flex flex-col min-h-screen bg-[var(--color-bg-light)]">
            <section className="pt-32 pb-16 bg-[var(--color-bg-cream)] relative overflow-hidden border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <FadeIn direction="up">
                        <span className="text-[var(--color-brand-red)] text-sm tracking-widest uppercase font-bold">Get In Touch</span>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-gray-100 box-shadow-soft bg-white">
                        ...
                        <div className="p-12 md:p-16 flex flex-col justify-center bg-[#FDF2EF]">
                            <FadeIn direction="left">
                                <h3 className="font-heading text-3xl font-bold mb-8 text-[var(--color-brand-red)]">Reach Out</h3>
                                ...
                                <div className="space-y-8">
                                    <div className="flex gap-6 items-start group">
                                        <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-[var(--color-brand-red)] group-hover:bg-[var(--color-brand-red)] group-hover:text-white transition-colors shrink-0 shadow-sm">
                                            <MapPin size={24} />
                                        </div>
                                        <div>
                                            <h4 className="text-[var(--color-heading)] font-bold text-lg mb-1">Location</h4>
                                            <p className="text-[var(--color-text)] font-medium leading-relaxed">Based in the heart of the city, in the plush KUKATPALLY, Hyderabad.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-6 items-start group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[var(--color-text)] font-medium">+91 XXXXX XXXXX</p>
                                        </div>
                                    </div>
                            ...
                            <FadeIn direction="right" delay={0.2} className="relative z-10 h-full flex flex-col justify-center">
                                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-[var(--color-heading)] focus:outline-none focus:border-[var(--color-brand-red)] focus:ring-1 focus:ring-[var(--color-brand-red)] transition-all font-medium"
                                    ...
                                    <div>
                                        ...
                                        <select
                                            className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-[var(--color-heading)] focus:outline-none focus:border-[var(--color-brand-red)] focus:ring-1 focus:ring-[var(--color-brand-red)] transition-all appearance-none font-medium"
                                            defaultValue=""
                                        >
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            rows={5}
                                            className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-[var(--color-heading)] focus:outline-none focus:border-[var(--color-brand-red)] focus:ring-1 focus:ring-[var(--color-brand-red)] transition-all resize-none font-medium"
